## Facet Zoom from left to right (easier to read)
## Source: https://stackoverflow.com/questions/52665619/how-to-change-the-position-of-the-zoomed-area-from-facet-zoom
